            ...
            <div className="container items-center absolute -top-10 xl:top-0 left-0 right-0 w-full h-full flex text-black px-4 sm:px-6 lg:px-8">
                <div className='flex flex-col-reverse lg:flex-row justify-between items-center'>
                    ...
                    <div className='w-full lg:w-6/12'>
                        <h1 className='text-[#036] text-[24px] md:text-[48px] font-[700] font-syne leading-[28px] md:leading-[57px] mb-3'>Who we Are</h1>
                        <p className='text-[#4A4C56] text-[14px] leading-[21px] md:leading-[27px] md:text-[18px] font-[400px] font-nunito-sans'>Laskar & Co Auto is a car management company dedicated to transforming corporate transportation for small to mid-sized businesses. We provide transparent, reliable, and tailored solutions, eliminating hidden fees and unpredictable billing to help businesses optimize and streamline their fleet operations with ease.</p>

                        <div className='hidden sm:block mt-10 mb-5'>
                        ...
                        <ul className='list-disc pl-5 mt-5 flex flex-col gap-5'>
                    ...
                    {/* right side */}
                    <div className='w-full lg:w-6/12 flex justify-end sm:justify-center lg:justify-end'>
